...
declare type LiteralUnion<U extends T, T extends {} = string> =
  | U | (T & {});
  
declare type StringLiteralUnion<S extends string> =
  `${S}` extends `${infer Str extends string}` ? Str | (string & {}) : never;

declare type BigIntOrNumber = number | bigint;

declare type Zero = 0 | 0n;

declare type ParseInt<S extends string | BigIntOrNumber> =
 ...
 * @category Numeric
 */
declare type Finite<T extends BigIntOrNumber> =
  | T extends PositiveInfinity | NegativeInfinity ? never : T;

/**
 * 
 * @category Numeric
 */
declare type Infinite<T extends BigIntOrNumber> =
  | T extends PositiveInfinity | NegativeInfinity ? T : never;

/**
 * 
 * @category Numeric
 */
declare type Integer<T extends BigIntOrNumber> = 
 ...
 * @category Numeric
 */
declare type Float<T extends BigIntOrNumber> =
  | T extends Integer<T> ? never : T;
 ...
 * @category Numeric
*/
declare type Negative<T extends BigIntOrNumber> =
 ...
 * @category Numeric
*/
declare type NonNegative<T extends BigIntOrNumber> = T extends Zero ? T : Negative<T> extends never ? T : never;
 ...
 * @category Numeric
*/
declare type NonNegativeInteger<T extends BigIntOrNumber> = NonNegative<Integer<T>>;
